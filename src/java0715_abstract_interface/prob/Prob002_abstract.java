...
/*
 * String sn=new Stirng("java");
 * char data=sn.charAt(2);
 * sysout(data) -> 'v'
 * 
 * String ko=sn.substring(0,3);
 * sysout(ko) -> jav
 * String mm=sn.substring(1,2);
 * sysout(mm) -> a
 * 
 * String ss=new String("2134");
 * int num=Integer.parseInt(ss.substirng(1,3));
 */
