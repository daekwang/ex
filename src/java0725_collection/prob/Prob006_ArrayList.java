...
public class Prob006_ArrayList {
	...
	public static void prnDisplay(ArrayList<Kospi> aList){
		...
		for(Kospi kos:aList){
			if(kos.getFluctuation().contains("상승가")){
				System.out.println("주가종목: "+kos.getStock());
				System.out.println("현재가격: "+kos.getPrice());
				System.out.println("등락가격: "+kos.getFluctuation().substring(4,8));
				System.out.println();
			}
		}
